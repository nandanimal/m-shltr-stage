    ...
    return (
        <div className="nav-container w-full p-2 items-center justify-center flex fixed z-100">
            <motion.div
                ...
                className={`navbar w-full rounded-sm hover:shadow-[0_0_8px_0_rgb(255,255,255)_inset,0_4px_10px_0_rgba(0,0,0,0.04)] transition ${
                    menuOpen
                        ? "bg-[rgba(242, 242, 238, 0.70)] backdrop-blur-lg shadow-[0_0_8px_0_rgb(255,255,255)_inset,0_4px_10px_0_rgba(0,0,0,0.04)]"
                        : ""
                }`}
                style={
                    {
