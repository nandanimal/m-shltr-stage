            ...
            <div className="max-w-6xl m-auto px-4 sm:px-6">
                ...
                >
                    <div className="sticky top-0 h-screen flex items-center justify-center relative">
                        <div className="flex items-center justify-between absolute bottom-0 w-full type-eyebrow text-gray tracking-[0.18em] mb-6">
                                ...
                                >
                                    ...
                                    <div className="w-full lg:w-1/2 flex flex-col gap-4 lg:gap-6 max-w-xl">
                                        ...
                                        >
                                            ...
                                            <h3 className="type-h2 mt-8 font-semibold text-[#272727] leading-tight">
                                                {step.title}
                                            </h3>
                                            <p className="type-body font-roboto text-[#272727] leading-relaxed tracking-wide">
                                                {step.description}
                                            </p>
